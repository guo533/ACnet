...
def visualize_instances_dict(
    ...
    for idx, [inst_id, inst_info] in enumerate(inst_dict.items()):
        ...
        inst_colour = list(inst_colour)
        inst_colour[0] = int(inst_colour[0])
        inst_colour[1] = int(inst_colour[1])
        inst_colour[2] = int(inst_colour[2])
        inst_colour = tuple(inst_colour)
