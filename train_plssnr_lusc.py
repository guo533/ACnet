...
def train(opt):
    ...
    ################# Schedulers ################
    # net_scheduler = optim.lr_scheduler.StepLR(net_optimizer, opt.gen_learning_rate_change_freq, verbose=True)
    ...
    for epoch in range(opt.warmup_epoch + 1, opt.epochs):
        ...
        for batch_idx, batch_data in enumerate(labeled_dataloader):
            ...
            with amp.autocast():
                ...
                labeled_pred_postprocessed_output_prototypes = [None, None]
...
def parse_opt():
    ...
    parser.add_argument('--labeled-dataset-dir', type=str, default=r'D:\CJH\data\generated\半监督LUSC\new_data_patches\labeled')
    parser.add_argument('--unlabeled-dataset-dir', type=str, default=r'D:\CJH\data\generated\半监督LUSC\new_data_patches\unlabeled')
