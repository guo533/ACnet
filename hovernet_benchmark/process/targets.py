...
import hovernet_benchmark.data.augs as augs
...
def gen_instance_hv_map(ann, crop_shape):
    ...
    fixed_ann = augs.fix_mirror_padding(orig_ann)
...
def prep_sample(data, is_batch=False, **kwargs):
    ...
    def colorize(ch, vmin, vmax, shape):
        ...
        ch_cmap = utils.center_pad_to_shape(ch_cmap, shape)
        return ch_cmap
    ...
    def prep_one_sample(data):
        ...
        img = utils.center_pad_to_shape(data["img"], shape)
